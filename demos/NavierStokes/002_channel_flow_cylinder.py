...
facet_types_vel = {"Wall":"d", "Cylinder":"d", "Inflow":"d", "Outflow":"n"}
facet_types_phi = {"Wall":"n", "Cylinder":"n", "Inflow":"n", "Outflow":"d"}

cloud_vel = GmshCloud(filename="./meshes/channel_cylinder.py", facet_types=facet_types_vel, support_size="max")
...
bc_u = {"Wall":zero, "Cylinder":zero, "Inflow":parabolic, "Outflow":zero}
bc_v = {"Wall":zero, "Cylinder":zero, "Inflow":zero, "Outflow":zero}
bc_phi = {"Wall":zero, "Cylinder":zero, "Inflow":zero, "Outflow":zero}
