...
cloud.visualize_field(sol.vals, cmap="jet", projection="3d", title="Optimized solution", ax=ax1)
cloud.visualize_field(exact_sol, cmap="jet", projection="3d", title="Analytical solution", ax=ax2)
cloud.visualize_field(jnp.abs(sol.vals-exact_sol), cmap="magma", projection="3d", title="Absolute error", ax=ax3)
############# fun ends ##########
