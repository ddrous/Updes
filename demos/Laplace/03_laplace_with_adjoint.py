...
# train_cloud.visualize_field(exact_sol, cmap="jet", projection="2d", title="Analytical solution", ax=ax2, vmin=-1, vmax=1)
...
# plt.savefig(DATAFOLDER+"bcn_dal"+".png", transparent=True, bbox_inches="tight", dpi=600)
